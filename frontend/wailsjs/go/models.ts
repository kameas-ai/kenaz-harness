...
export namespace tools {
	...
	export class FileSetupGuide {
	    target_path: string;
	    steps: string[];
	    docs_url?: string;
	
	    static createFrom(source: any = {}) {
	        return new FileSetupGuide(source);
	    }
	...
	export class MissingPrereq {
	    ...
	    install_hint: string;
	    kind?: string;
	    file_setup_guide?: FileSetupGuide;
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.kind = source["kind"];
	        this.file_setup_guide = this.convertValues(source["file_setup_guide"], FileSetupGuide);
	    }
