...
Kaneaz-harness today gives the user a chat surface, a tool catalog, an artifact pipeline, and a Cedar-gated execution model. What it does NOT give the user is a way to **package a repeatable multi-step procedure** they perform regularly into something reusable.
