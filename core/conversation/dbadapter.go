...
// consume it through the narrower conversation.DB contract. The
// storage and conversation surfaces share method shapes; this adapter
// only handles the type translation across packages.
