...
// Keychain key constants for fleet tokens.
const (
	keyringService      = "kaneaz-harness"
	keyAccessToken      = "fleet:default:access_token"
	keyRefreshToken     = "fleet:default:refresh_token"
	keyExpiresAt        = "fleet:default:expires_at"
)
