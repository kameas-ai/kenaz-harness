...
func TestOpen_RegistersSessionMigrations(t *testing.T) {
	...
	// 0311 (subagent-metadata) lands with
	// branch-as-subagent-recommendation WP04.
	want := []int{300, 301, 302, 303, 304, 305, 306, 307, 308, 309, 310, 311}
...
func TestOpen_ApplyIdempotent(t *testing.T) {
	...
	// 1 subagent-metadata (0311) = 14.
	if count != 14 {
		t.Errorf("ledger count = %d, want 14", count)
	}
}
