...
// WithHTTPClient option still wins — tests that pass an
// httptest.Server's client (which has Transport=nil) must not be
// silently shadowed by the keepalive default.
