...
const (
	...
	//     sub-agent branches.
	//
	//   ActionToolSubagentPause — gates Subagent_Pause (owner ruling
	//     E-002: pause means "stop after the current turn, start no
	//     further turn"). Resource UID: SubagentBranch::"<branch-id>" —
	//     same family as Abort/Steer above.
	//
