...
// Migrations returns the four event-log migrations in dependency
// order. The harness bootstrap calls this function and forwards the
// result to the storage-foundations migration framework.
