...
//
// session_sweep.go implements the soft-archive retention sweep (plan §2.7). The
// threshold-mode and rolling-mode engines (session_engine.go, session_rolling.go) only
