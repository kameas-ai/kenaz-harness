...
//
// Numbering: 0313 — next free version in the sessions block (300-399)
// after 0312 (cross-session-search FTS5).
const migrationIDSubagent = "sessions/0313-subagent-metadata"
...
// safe defaults).
func migration0313() migrations.Migration {
