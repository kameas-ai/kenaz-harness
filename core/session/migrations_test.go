...
func TestMigrations_RegisterAndApply(t *testing.T) {
	...
	// Ledger rows: 2 storage bootstrap + 20 sessions migrations
	...
	// 0318 kind + 0319 workflows) = 22 applied entries
	// (2 chassis bootstrap + 20 sessions migrations).
	if got := len(db.ledger); got != 22 {
		t.Fatalf("ledger size = %d, want 22", got)
	}
	wantVersions := []int{1, 2, 300, 301, 302, 303, 304, 305, 306, 307, 308, 309, 310, 311, 312, 313, 314, 315, 316, 317, 318, 319}
