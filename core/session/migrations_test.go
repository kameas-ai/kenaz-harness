...
func TestMigrations_RegisterAndApply(t *testing.T) {
	...
	// 0317 streaming_resume_columns) = 19 applied entries
	// (2 chassis bootstrap + 17 sessions migrations).
	if got := len(db.ledger); got != 19 {
		t.Fatalf("ledger size = %d, want 19", got)
	}
	wantVersions := []int{1, 2, 300, 301, 302, 303, 304, 305, 306, 307, 308, 309, 310, 311, 312, 313, 314, 316, 317}
