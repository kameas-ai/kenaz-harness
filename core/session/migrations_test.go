...
func TestMigrations_RegisterAndApply(t *testing.T) {
	...
	// Ledger rows: 2 storage bootstrap + 23 sessions migrations
	...
	// 0321 workflow_schedules + 0322 last_usage_json) =
	// 25 applied entries (2 chassis bootstrap + 23 sessions migrations).
	if got := len(db.ledger); got != 25 {
		t.Fatalf("ledger size = %d, want 25", got)
	}
	wantVersions := []int{1, 2, 300, 301, 302, 303, 304, 305, 306, 307, 308, 309, 310, 311, 312, 313, 314, 315, 316, 317, 318, 319, 320, 321, 322}
