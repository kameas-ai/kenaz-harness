...
// NewStorageDB wraps a storage.DB so the session SQL store can consume
// it through the narrower session.DB contract. The storage and session
// surfaces share method shapes; this adapter only handles the type
// translation across packages.
