...
const wantServedMethodCount = 49 // +3: Fleet_GetTelemetryConsent, Fleet_SetTelemetryConsent, Fleet_TelemetryStatus; +7: Documents_{BuildSite,Create,ExportsDir,Get,List,Preview,Update} (contracts/documents-rpc.md)
